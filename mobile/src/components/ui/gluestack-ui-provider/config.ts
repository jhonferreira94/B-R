...
export const config = {
  light: vars({
    /* Primary - Crimson/Rose (logo #DD1C4A) */
    '--color-primary-0': '255 245 247',    // #FFF5F7
    '--color-primary-50': '255 228 235',   // #FFE4EB
    '--color-primary-100': '255 193 207',  // #FFC1CF
    '--color-primary-200': '255 146 172',  // #FF92AC
    '--color-primary-300': '250 94 132',   // #FA5E84
    '--color-primary-400': '237 58 102',   // #ED3A66
    '--color-primary-500': '221 28 74',    // #DD1C4A
    '--color-primary-600': '194 18 63',    // #C2123F
    '--color-primary-700': '162 13 52',    // #A20D34
    '--color-primary-800': '126 9 40',     // #7E0928
    '--color-primary-900': '92 6 29',      // #5C061D
    '--color-primary-950': '58 3 18',      // #3A0312
    ...
    '--color-typography-950': '39 38 36',      // #272624
    ...
    '--color-background-100': '245 241 235',
  ...
  dark: vars({
    /* Primary - Crimson/Rose dark */
    '--color-primary-0': '58 3 18',
    '--color-primary-50': '92 6 29',
    '--color-primary-100': '126 9 40',
    '--color-primary-200': '162 13 52',
    '--color-primary-300': '194 18 63',
    '--color-primary-400': '221 28 74',
    '--color-primary-500': '237 58 102',
    '--color-primary-600': '250 94 132',
    '--color-primary-700': '255 146 172',
    '--color-primary-800': '255 193 207',
    '--color-primary-900': '255 228 235',
    '--color-primary-950': '255 245 247',
