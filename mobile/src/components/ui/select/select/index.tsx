...
const SelectInputGlueStackUI = React.forwardRef<
  React.ComponentRef<typeof UISelect.Input>,
  ISelectInputProps
>(function SelectInputGlueStackUI({ className, ...props }, ref) {
...
SelectInputGlueStackUI.displayName = 'SelectInputGlueStackUI';
